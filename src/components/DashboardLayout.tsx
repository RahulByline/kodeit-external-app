...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children, userRole, userName, studentGrade, dashboardType }) => {
          ...
          <div className="px-4 lg:px-6 py-2">
            <div className="flex items-center justify-between">
              <div className="flex-1 max-w-md">
                {userRole === 'student' && studentGrade && dashboardType ? (
                  // Grade indicator for students
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm font-medium">
                        {dashboardType === 'G1_G3' && 'Early Elementary'}
                        {dashboardType === 'G4_G7' && 'Upper Elementary'}
                        {dashboardType === 'G8_PLUS' && 'High School'}
                      </div>
                    </div>
                  </div>
                ) : (
                  // Search bar for other roles
