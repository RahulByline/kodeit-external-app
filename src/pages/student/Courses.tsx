  ...
  const handleCourseClick = async (course: Course) => {
    ...
    try {
      ...
      if (courseDetails) {
        ...
        const activities = (courseDetails as any).activities || [];
        ...
        if (courseDetailsAny.completion) {
          setSelectedCourse(prev => prev ? {
            ...prev,
            progress: courseDetailsAny.completion.progresspercentage || prev.progress,
            totalModules: courseDetailsAny.totalModules || activities.length,
            completedModules: courseDetailsAny.completedModules || activities.filter((a: any) =>
          ...
          <div className=" mx-auto space-y-6">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">
                        Real-time course data from Moodle API • {courses.length} available courses
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="group bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-lg transition-all duration-500 hover:scale-105">
                ...
                <h3 className="text-base font-semibold text-gray-900 mb-1">All Courses</h3>
                <p className="text-sm text-gray-600">Complete overview of your learning</p>
              </div>
              ...
              <div className="group bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-lg transition-all duration-500 hover:scale-105">
                ...
                <p className="text-sm text-gray-600">Currently learning courses</p>
              </div>
              ...
              <div className="group bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-lg transition-all duration-500 hover:scale-105">
                ...
                <p className="text-sm text-gray-600">Successfully completed courses</p>
              </div>
              ...
              <div className="group bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-lg transition-all duration-500 hover:scale-105">
                ...
                <h3 className="text-base font-semibold text-gray-900 mb-1">Progress</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredCourses.map((course, index) => (
                <div
                  key={course.id}
                  className="group bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-500 hover:scale-[1.02] overflow-hidden"
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <div className={`px-2 py-1 rounded-full text-xs font-semibold ${course.status === 'completed' ? 'bg-green-100 text-green-700 border border-green-200' :
                          course.status === 'in_progress' ? 'bg-blue-100 text-blue-700 border border-blue-200' :
                    ...
                    <div className="space-y-3 mb-4">
                      <div>
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                            className={`h-2 rounded-full transition-all duration-1000 ${course.progress >= 100 ? 'bg-gradient-to-r from-green-500 to-emerald-500' :
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4 text-sm">
                      <div className="space-y-1">
                        ...
                        <p className="font-semibold text-gray-900 truncate">{course.instructor}</p>
                      </div>
                      <div className="space-y-1">
                        <div className="flex items-center space-x-1">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="font-semibold text-gray-900">{course.completedModules}/{course.totalModules}</p>
                      </div>
                      <div className="space-y-1">
                        <div className="flex items-center space-x-1">
                    ...
                    <div className="flex space-x-2">
                      <Button
                        variant="outline"
                        size="sm"
                        className="flex-1 border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-300 text-sm"
                      ...
                      <Button
                        size="sm"
                        className="flex-1 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 shadow-md hover:shadow-lg text-sm"
                      >
                              ...
                              {courseModules.map((module) => (
                                <div key={module.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                  <div className="flex items-center justify-between mb-2">
                                    ...
                                    <span className={`px-2 py-1 text-xs rounded-full ${module.completion === 100 ? 'bg-green-100 text-green-800' :
                                  ...
                                  <div key={activity.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                    <div className="flex items-center justify-between mb-2">
                                      ...
                                      <div className="flex items-center space-x-2">
                                        ...
                                        <span className={`px-2 py-1 text-xs rounded-full ${activity.completed ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                                          }`}>
